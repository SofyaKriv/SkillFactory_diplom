...
urlpatterns = [
    ...
    path('accounts/profile/', chat_views.main_page),
    ...
    path('categories/subscribe/<int:pk>', app_views.subscribe_me),
    path('categories/unsubscribe/<int:pk>', app_views.unsubscribe_me),
    path('videos/$', app_views.VideoList.as_view(), name='videos'),
    path(r'^videos/(?P<pk>\d+)$', app_views.VideoDetail.as_view(), name='video-detail'),
    # path('api/videos/<int:pk>', app_views.video_list, name='video-detail'),
    # path('api/videos', app_views.video_list, name='video-list'),
